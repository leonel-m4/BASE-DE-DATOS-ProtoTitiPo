...
var productos = [
    {
        ...
        precio: 120,
        img: base + "/img/accesorios/accs1.jpeg"
    },
    {
        nombre: "Bufanda a Cuadros",
        precio: 55,
        img: base + "/img/accesorios/accs2.jpeg"
    },
    {
        nombre: "Cinturón de Piel con Hebilla Minimalista",
        precio: 65,
        img: base + "/img/accesorios/accs3.jpeg"
    },
    {
        nombre: "Gafas de Sol Estilo Aviador",
        precio: 95,
        img: base + "/img/accesorios/accs4.jpeg"
    },
    {
        nombre: "Mochila de Cuero Elegante",
        precio: 140,
        img: base + "/img/accesorios/accs5.jpeg"
    },
    {
        nombre: "Collar con Dije Geométrico",
        precio: 35,
        img: base + "/img/accesorios/accs6.jpeg"
    },
    {
        nombre: "Brazaletes Apilables",
        precio: 45,
        img: base + "/img/accesorios/accs7.jpeg"
    },
    {
        nombre: "Gorro de Lana (Beanie)",
        precio: 30,
        img: base + "/img/accesorios/accs8.jpeg"
    }
];
...
productos.forEach((p, i) => {
    contenedor.innerHTML += `
        <div class="row">
            <a href="https://leonel-m4.github.io/BASE-DE-DATOS-ProtoTitiPo/products/productoAccsesorios.html?id=${i}">
                <img src="${p.img}" alt="">
            </a>
